        ...
        <body style="font-family:Arial,sans-serif;background:#f4f4f4;padding:20px;">
            <div style="max-width:600px;margin:auto;background:white;border-radius:12px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.1);">
                ...
                <div style="background:linear-gradient(135deg,#040d21,#0f2040);padding:30px;text-align:center;">
                    ...
                    <p style="color:rgba(255,255,255,0.6);margin:8px 0 0;font-size:14px;">FlyEdu Abroad — Contact Form Submission</p>
                </div>
                ...
                <div style="padding:30px;">
                    <table style="width:100%;border-collapse:collapse;">
                        ...
                        <tr style="border-bottom:1px solid #eee;background:#fafafa;">
                            ...
                            <td style="padding:14px 8px;font-size:15px;">
                                <a href="tel:{data.get('phone')}" style="color:#0d6efd;font-weight:600;text-decoration:none;">{data.get('phone')}</a>
                            </td>
                        </tr>
                        <tr style="border-bottom:1px solid #eee;">
                    ...
                    <div style="margin-top:28px;text-align:center;">
                        <a href="https://wa.me/{data.get('phone','').replace('+','').replace(' ','')}"
                           style="background:#25d366;color:white;padding:14px 32px;border-radius:50px;text-decoration:none;font-weight:700;font-size:15px;display:inline-block;box-shadow:0 4px 15px rgba(37,211,102,0.4);">
